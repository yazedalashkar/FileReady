...
export const UI_TRANSLATIONS = {
  en: {
    ...
    // Smart Scan Cleanup
    scanCleanupTitle: 'Smart Scan Cleanup',
    scanCleanupSubtitle: 'Automatically detect and clean skew, gray backgrounds, excessive margins, and blank pages in scanned PDFs.',
    scanDropzonePrompt: 'Drop a scanned PDF here, or click to browse',
    scanAnalyzingTitle: 'Analyzing scanned pages...',
    scanFindingsTitle: 'Scan Defects Detected',
    scanNoDefects: 'No significant scan defects detected. All pages look clean.',
    scanOptDeskew: 'Deskew pages (straighten tilted text)',
    scanOptCropMargins: 'Auto-crop excessive margins',
    scanOptCleanBg: 'Background cleanup (whiten gray/uneven paper)',
    scanOptRemoveBlank: 'Remove blank pages',
    scanOptNormalizeOrient: 'Normalize page orientation',
    scanPagesSkewed: '{count} pages slightly skewed',
    scanPagesMargins: '{count} pages have excessive margins',
    scanPagesBg: '{count} pages have uneven background',
    scanPagesBlank: '{count} blank pages detected',
    scanPagesOrient: '{count} pages have different orientation',
    scanBtnClean: 'Clean Scanned PDF',
    scanReviewBlankPages: 'Review pages',
    scanModalBlankTitle: 'Confirm Removing Blank Pages',
    scanModalBlankDesc: 'The following {count} page(s) were identified as blank:',
    scanModalBlankPrompt: 'Do you want to exclude these pages from the cleaned document?',
    scanModalBtnRemove: 'Remove {count} Pages',
    scanCompleteTitle: 'SCAN CLEANUP COMPLETE ✓',
    scanBefore: 'Before',
    scanAfter: 'After',
    scanDeskewed: '{count} pages deskewed',
    scanCropped: '{count} pages cropped',
    scanBgCleaned: '{count} backgrounds cleaned',
    scanBlankRemoved: '{count} blank pages removed',
    scanNormalized: '{count} pages normalized',
    scanDownloadBtn: 'Download Clean PDF',
    scanStartOver: 'Clean Another PDF',
    scanCleanAnother: 'Start Over',
    // Flatten PDF Tool
    toolTitleFlattenPdf: 'Flatten PDF',
    toolBadgeFlattenPdf: 'Security',
    toolDescFlattenPdf: 'Lock fillable form fields, burn-in signatures, and make PDFs permanently non-editable for portal submission.',
    flattenDropzonePrompt: 'Drop a fillable or multi-layer PDF here, or click to browse',
    flattenAnalyzingTitle: 'Analyzing document form fields and layers...',
    flattenFindingsTitle: 'Form Fields & Security Status',
    flattenFormsFound: '{count} interactive form field(s) detected and ready to be locked.',
    flattenNoForms: 'No active form fields detected. You can still flatten layers and sanitize metadata.',
    flattenModeTitle: 'Flattening Method',
    flattenModeVector: 'Vector Form Flattening (Recommended)',
    flattenModeVectorDesc: 'Converts all filled fields into permanent text. Keeps vector sharpness, small file size, and searchable text.',
    flattenModePrint: 'Full Visual Flattening (Print-to-PDF)',
    flattenModePrintDesc: 'Renders all pages into 100% flat static layers. Maximum compatibility for strict government & court portals.',
    flattenOptMetadata: 'Sanitize document metadata (remove author, creator, editing history)',
    flattenOptAnnotations: 'Strip non-essential annotations & comments',
    flattenBtnAction: 'Flatten & Lock PDF',
    flattenSuccessTitle: 'PDF FLATTENED & LOCKED ✓',
    flattenSuccessDesc: 'All interactive form fields and layers have been permanently merged. The document is 100% static and portal-ready.',
    flattenBefore: 'Before Flattening',
    flattenAfter: 'After Flattening',
    flattenFieldsCount: 'Interactive fields:',
    flattenFileSize: 'File size:',
    flattenPageCount: 'Pages:',
    flattenLockedStatus: 'Status:',
    flattenLockedVal: '100% Non-Editable',
  ...
  ar: {
    ...
    // Smart Scan Cleanup
    scanCleanupTitle: 'تنظيف المستندات الممسوحة',
    scanCleanupSubtitle: 'اكتشاف وتصحيح ميل الصفحات، الهوامش الزائدة، الخلفيات الرمادية، والصفحات الفارغة تلقائياً.',
    scanDropzonePrompt: 'أسقط ملف PDF الممسوح هنا، أو انقر للاختيار',
    scanAnalyzingTitle: 'جاري فحص وتحليل صفحات المسح الضوئي...',
    scanFindingsTitle: 'المشاكل والعيوب المكتشفة',
    scanNoDefects: 'لم يتم اكتشاف عيوب ملحوظة، تبدو جميع الصفحات نظيفة ومستقيمة.',
    scanOptDeskew: 'تصحيح ميل الصفحات (تعديل النصوص المائلة)',
    scanOptCropMargins: 'قص الهوامش الزائدة تلقائياً',
    scanOptCleanBg: 'تنظيف الخلفية (تبييض الورق الرمادي أو غير المتجانس)',
    scanOptRemoveBlank: 'حذف الصفحات الفارغة',
    scanOptNormalizeOrient: 'توحيد اتجاه الصفحات',
    scanPagesSkewed: '{count} صفحة مائلة قليلاً',
    scanPagesMargins: '{count} صفحة بها هوامش زائدة',
    scanPagesBg: '{count} صفحة بخلفية غير متجانسة',
    scanPagesBlank: '{count} صفحة فارغة تم اكتشافها',
    scanPagesOrient: '{count} صفحة باتجاه مختلف',
    scanBtnClean: 'تنظيف المستند الآن',
    scanReviewBlankPages: 'مراجعة الصفحات',
    scanModalBlankTitle: 'تأكيد إزالة الصفحات الفارغة',
    scanModalBlankDesc: 'تم تحديد الصفحات التالية ({count}) كصفحات فارغة:',
    scanModalBlankPrompt: 'هل ترغب في استبعاد هذه الصفحات من المستند الناتج نهائياً؟',
    scanModalBtnRemove: 'حذف {count} صفحات',
    scanCompleteTitle: 'تم تنظيف المستند بنجاح ✓',
    scanBefore: 'قبل المعالجة',
    scanAfter: 'بعد المعالجة',
    scanDeskewed: 'تم تعديل ميل {count} صفحة',
    scanCropped: 'تم قص هوامش {count} صفحة',
    scanBgCleaned: 'تم تنظيف خلفيات {count} صفحة',
    scanBlankRemoved: 'تم حذف {count} صفحة فارغة',
    scanNormalized: 'تم توحيد اتجاه {count} صفحة',
    scanDownloadBtn: 'تنزيل المستند النظيف',
    scanStartOver: 'تنظيف ملف آخر',
    scanCleanAnother: 'البدء من جديد',
    // أداة تسطيح وتأمين PDF
    toolTitleFlattenPdf: 'تسطيح وتأمين PDF',
    toolBadgeFlattenPdf: 'أمان',
    toolDescFlattenPdf: 'تثبيت حقول النماذج المعبأة، حرق التواقيع، وجعل ملف الـ PDF غير قابل للتعديل نهائياً لبوابات التقديم.',
    flattenDropzonePrompt: 'أسقط ملف PDF التفاعلي هنا، أو انقر للاختيار',
    flattenAnalyzingTitle: 'جاري فحص الحقول التفاعلية والطبقات...',
    flattenFindingsTitle: 'حالة الحقول التفاعلية والأمان',
    flattenFormsFound: 'تم اكتشاف {count} حقل تفاعلي جاهز للتثبيت والتأمين.',
    flattenNoForms: 'لم يتم رصد حقول تفاعلية نشطة، لكن لا يزال بإمكانك تسطيح الطبقات وتطهير البيانات.',
    flattenModeTitle: 'طريقة التسطيح',
    flattenModeVector: 'تسطيح النماذج المتجهي (موصى به)',
    flattenModeVectorDesc: 'تثبيت الحقول المعبأة مع إبقاء النصوص حادة وقابلة للبحث وحجم الملف صغيراً.',
    flattenModePrint: 'التسطيح البصري الكامل (Print-to-PDF)',
    flattenModePrintDesc: 'تحويل المستند إلى صفحات مسطحة 100% تضمن القبول التام في بوابات الهجرة والمحاكم.',
    flattenOptMetadata: 'تطهير البيانات الوصفية (حذف معلومات المؤلف، البرنامج، وتاريخ التعديل)',
    flattenOptAnnotations: 'إزالة التعليقات والملاحظات غير الضرورية',
    flattenBtnAction: 'تسطيح وتأمين الـ PDF الآن',
    flattenSuccessTitle: 'تم تسطيح وتأمين المستند بنجاح ✓',
    flattenSuccessDesc: 'تم دمج كافة الحقول والطبقات نهائياً. المستند الآن ثابت بنسبة 100% ومطابق لبوابات التقديم.',
    flattenBefore: 'قبل التسطيح',
    flattenAfter: 'بعد التسطيح',
    flattenFieldsCount: 'الحقول التفاعلية:',
    flattenFileSize: 'حجم الملف:',
    flattenPageCount: 'الصفحات:',
    flattenLockedStatus: 'الحالة:',
    flattenLockedVal: 'غير قابل للتعديل نهائياً',
